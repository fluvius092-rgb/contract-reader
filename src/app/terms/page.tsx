      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-1">
              <li>本サービスはアカウント登録なしで1回、Googleアカウント登録後にさらに1回、合計2回まで無料でご利用いただけます。継続してご利用いただく場合は、都度払いまたは月額プラン（有料）にお申込みください。</li>
              <li>アカウント登録をしなくても基本的な機能をご利用いただけます。解析履歴の保存機能や有料プランへのお申込みには、アカウント登録が必要です。</li>
