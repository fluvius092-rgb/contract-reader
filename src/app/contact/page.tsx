              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1">
                      A: アカウント登録なしで1回（最大10枚）、Googleアカウントで登録するとさらに1回（最大20枚）、合計2回まで無料でお試しいただけます。
                      無料お試しは1人1回限りで月次更新はありません。続けてご利用いただく場合は、都度払い（¥200）または月額プランをお選びください。
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="mt-2 space-y-1 pl-4">
                      <li>・<strong>都度払い（¥200）</strong>: 1回だけ使いたい方向け。最大20枚まで対応。有効期限なし。</li>
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900">Q: 都度払いの有効期限はありますか？</h4>
                    <p className="mt-1">
                      A: 有効期限はありません。購入後、好きなタイミングでご利用いただけます。複数回購入した場合も、残った回数はそのまま繰り越されます。
                    </p>
                  </div>
