        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                <strong>無料でお試し可能</strong>: 会員登録なしで1回、登録後にさらに1回、合計2回まで無料でお試しいただけます。
                すぐにお使いいただけますので、まずはお気軽にお試しください。
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              <Link href="/contact" className="text-blue-600 hover:underline">お問い合わせページ</Link>よりお気軽にご連絡ください。
            </p>
          </section>
